...
import PHIMG from '../../image/gym1.jpg'
import './pictures.css'
const Pictures = () => {
  ...
  return (
    <div>
      ...
      <h2 className='h1'>About us</h2>
        <img src={PHIMG} alt="" className='phimg' />
...
<div class="container">
	<div class="top">
    	<ul>
        	<li><a href="#img_1"><img src="https://image.freepik.com/free-photo/sunlight-in-the-forest_1004-9.jpg"/></a></li>
            <li><a href="#img_2"><img src="https://image.freepik.com/free-photo/sunlight-in-the-forest_1004-9.jpg"/></a></li>
            ...
            <li><a href="#img_4"><img src="https://image.freepik.com/free-photo/sunlight-in-the-forest_1004-9.jpg"/></a></li>
